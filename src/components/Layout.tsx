...
import { GraduationCap, UserCheck, LayoutDashboard, LogOut, Building2, Building, Users, Activity, FolderSync, FileSearch, Smartphone, Settings, Menu, X, ArrowLeft, Brain, BookUser } from 'lucide-react';
...
const getNavigationForRole = (role: string | undefined) => {
  ...
  const roleSpecificNav = {
    ...
    department_admin: [
      ...
      { name: 'User Directory', href: '/user-directory', icon: BookUser },
